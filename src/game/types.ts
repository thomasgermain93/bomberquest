...
export const HERO_VISUALS: Record<string, { family: HeroFamilyId; traits: HeroVisualTraits }> = {
  ...
  brick: { family: 'forge-guard', traits: { helmetStyle: 'standard', cape: false, wings: false, aura: false, accentColor: '#7A6F63' } },
  ...
  shade: { family: 'shadow-core', traits: { helmetStyle: 'mask', cape: true, wings: false, aura: true, accentColor: '#6A4C93' } },
  ...
  glitch: { family: 'arcane-circuit', traits: { helmetStyle: 'tech', cape: false, wings: false, aura: true, accentColor: '#00F5D4' } },
  rune: { family: 'arcane-circuit', traits: { helmetStyle: 'tech', cape: true, wings: false, aura: true, accentColor: '#7B2CBF' } },

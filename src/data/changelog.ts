...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    version: '1.6.1',
    date: '2026-03-15',
    title: 'Correctifs de stabilité & qualité de vie',
    changes: [
      { type: 'fix', description: 'fix: prevent NaN XP and restore XP gains for legacy heroes (#108)' },
      { type: 'fix', description: 'fix(changelog): utiliser src/data/changelog.ts sur la landing (#103)' },
      { type: 'fix', description: 'fix(cloud): unblock write-back after rollback guard (#100)' },
      { type: 'fix', description: 'fix: empêcher rollback héros au retour Profil -> Jeu (#90)' },
      { type: 'fix', description: 'fix: sauvegarder les fusions de héros en cloud (#89)' },
      { type: 'fix', description: 'fix: avoid false cloud fallback when auth session is restoring (#76)' },
      { type: 'fix', description: 'Bug: retour depuis Profil rollback l\'état local et fait perdre les dernières invocations (#74)' },
      { type: 'fix', description: 'Bug: chiffres clés landing toujours vides (follow-up) (#70)' },
      { type: 'fix', description: 'fix: robust username save check (follow-up #62) (#66)' },
      { type: 'fix', description: 'Bug d\'affichage (#56)' },
      { type: 'fix', description: 'fix: simplifier la sélection de héros en mode story (issue #28) (#36)' },
      { type: 'fix', description: 'fix: rendre le menu de landing responsive sur mobile (issue #24) (#33)' },
      { type: 'fix', description: 'fix: afficher les BC disponibles dans la popup d\'invocation (issue #32) (#35)' },
      { type: 'fix', description: 'fix: supprimer la barre de progression coffre superposée (issue #27) (#34)' },
      { type: 'fix', description: 'fix: bouton vitesse unique cyclique x1/x2/x3 (#23)' },
    ],
  },
  {
    version: '1.6.0',
